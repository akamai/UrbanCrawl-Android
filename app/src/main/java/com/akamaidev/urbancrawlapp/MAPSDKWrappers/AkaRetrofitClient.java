...
public class AkaRetrofitClient implements Client {
    ...
    @Override public Response execute(Request request) throws IOException {
        AkaURLConnection connection = openConnection(request);
    ...
    protected AkaURLConnection openConnection(Request request) throws IOException {
        AkaURLConnection connection =
                (AkaURLConnection) new URL(null, request.getUrl(), new AkaURLStreamHandler()).openConnection();
    ...
    Response readResponse(AkaURLConnection connection) throws IOException {
